...
function $s_Lraytracer_Entry__main__AT__V(args) {
  $m_Lraytracer_Entry$().main__AT__V(args)
}
function $p_Lraytracer_Entry$__render$1__Lorg_scalajs_dom_HTMLCanvasElement__Lorg_scalajs_dom_HTMLCanvasElement__Lraytracer_model_Dungeon__V($thiz, canvas$1, topDown$1, dungeon$1) {
  $m_Lraytracer_view_Raytracer$().clearScreen__Lorg_scalajs_dom_HTMLCanvasElement__V(canvas$1);
  $m_Lraytracer_view_Raytracer$().renderSky__Lorg_scalajs_dom_HTMLCanvasElement__V(canvas$1);
  $m_Lraytracer_view_Raytracer$().renderDungeon__Lorg_scalajs_dom_HTMLCanvasElement__Lraytracer_model_Dungeon__V(canvas$1, dungeon$1);
  $m_Lraytracer_view_TopDown$().clear__Lorg_scalajs_dom_HTMLCanvasElement__V(topDown$1);
  $m_Lraytracer_view_TopDown$().renderDungeon__Lorg_scalajs_dom_HTMLCanvasElement__Lraytracer_model_Dungeon__V(topDown$1, dungeon$1)
}
function $p_Lraytracer_Entry$__renderLoop$1__Lorg_scalajs_dom_HTMLCanvasElement__Lorg_scalajs_dom_HTMLCanvasElement__Lraytracer_model_Dungeon__V($thiz, canvas$2, topDown$2, dungeon$2) {
  $p_Lraytracer_Entry$__render$1__Lorg_scalajs_dom_HTMLCanvasElement__Lorg_scalajs_dom_HTMLCanvasElement__Lraytracer_model_Dungeon__V($thiz, canvas$2, topDown$2, dungeon$2);
  window.requestAnimationFrame(((_$1) => {
    $uD(_$1);
    return $uI(window.setTimeout((() => {
      $p_Lraytracer_Entry$__renderLoop$1__Lorg_scalajs_dom_HTMLCanvasElement__Lorg_scalajs_dom_HTMLCanvasElement__Lraytracer_model_Dungeon__V($thiz, canvas$2, topDown$2, dungeon$2)
    }), 16.0))
  }))
}
/** @constructor */
function $c_Lraytracer_Entry$() {
  /*<skip>*/
}
$c_Lraytracer_Entry$.prototype = new $h_O();
$c_Lraytracer_Entry$.prototype.constructor = $c_Lraytracer_Entry$;
/** @constructor */
function $h_Lraytracer_Entry$() {
  /*<skip>*/
}
$h_Lraytracer_Entry$.prototype = $c_Lraytracer_Entry$.prototype;
$c_Lraytracer_Entry$.prototype.main__AT__V = (function(args) {
  document.addEventListener("DOMContentLoaded", ((e) => {
    this.init__V()
  }))
});
$c_Lraytracer_Entry$.prototype.init__V = (function() {
  var canvas = document.getElementById("render");
  var topDown = document.getElementById("topDown");
  $m_Lraytracer_model_Room$();
  var roomOrigin = new $c_Lraytracer_model_Vector2D(0.0, 0.0);
  $m_Lraytracer_model_Room$();
  var roomHeight = 100.0;
  var room = new $c_Lraytracer_model_Room(roomOrigin, 100.0, 100.0, roomHeight);
  $m_Lraytracer_model_Room$();
  var roomOrigin$1 = new $c_Lraytracer_model_Vector2D(500.0, 500.0);
  $m_Lraytracer_model_Room$();
  var roomHeight$1 = 100.0;
  var room2 = new $c_Lraytracer_model_Room(roomOrigin$1, 200.0, 200.0, roomHeight$1);
  var playerX = (room.Lraytracer_model_Room__f_roomWidth / 2.0);
  var playerY = (room.Lraytracer_model_Room__f_roomHeight / 2.0);
  var playerRotationVector = new $c_Lraytracer_model_Vector2D(0.0, 1.0);
  var player = new $c_Lraytracer_model_Player(new $c_Lraytracer_model_Vector2D(playerX, playerY), playerRotationVector, 64.0);
  $n($m_s_package$().s_package$__f_List);
  var elems = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lraytracer_model_Room.getArrayOf().constr)([room, room2]));
  var rooms = $m_sci_Nil$().prependedAll__sc_IterableOnce__sci_List(elems);
  var dungeon = new $c_Lraytracer_model_Dungeon(rooms, player);
  window.addEventListener("keydown", ((event) => {
    var keyCode = $uI(event.keyCode);
    event.preventDefault();
    if ((keyCode === 37)) {
      player.Lraytracer_model_Player__f_dir = $n(player.Lraytracer_model_Player__f_dir).$plus__Lraytracer_model_Vector2D__Lraytracer_model_Vector2D($n($n(player.Lraytracer_model_Player__f_dir).rotate__D__Lraytracer_model_Vector2D((-1.5707963267948966))).$times__D__Lraytracer_model_Vector2D(player.Lraytracer_model_Player__f_speed));
      return (void 0)
    } else if ((keyCode === 39)) {
      player.Lraytracer_model_Player__f_dir = $n(player.Lraytracer_model_Player__f_dir).$minus__Lraytracer_model_Vector2D__Lraytracer_model_Vector2D($n($n(player.Lraytracer_model_Player__f_dir).rotate__D__Lraytracer_model_Vector2D((-1.5707963267948966))).$times__D__Lraytracer_model_Vector2D(player.Lraytracer_model_Player__f_speed));
      return (void 0)
    } else if ((keyCode === 38)) {
      player.Lraytracer_model_Player__f_pos = $n(player.Lraytracer_model_Player__f_pos).$plus__Lraytracer_model_Vector2D__Lraytracer_model_Vector2D($n(player.Lraytracer_model_Player__f_dir).$times__D__Lraytracer_model_Vector2D(player.Lraytracer_model_Player__f_rotSpeed));
      return (void 0)
    } else if ((keyCode === 40)) {
      player.Lraytracer_model_Player__f_pos = $n(player.Lraytracer_model_Player__f_pos).$minus__Lraytracer_model_Vector2D__Lraytracer_model_Vector2D($n(player.Lraytracer_model_Player__f_dir).$times__D__Lraytracer_model_Vector2D(player.Lraytracer_model_Player__f_rotSpeed));
      return (void 0)
    } else {
      return (void 0)
    }
  }));
  $p_Lraytracer_Entry$__renderLoop$1__Lorg_scalajs_dom_HTMLCanvasElement__Lorg_scalajs_dom_HTMLCanvasElement__Lraytracer_model_Dungeon__V(this, canvas, topDown, dungeon)
});
var $d_Lraytracer_Entry$ = new $TypeData().initClass({
  Lraytracer_Entry$: 0
}, false, "raytracer.Entry$", {
  Lraytracer_Entry$: 1,
  O: 1
});
$c_Lraytracer_Entry$.prototype.$classData = $d_Lraytracer_Entry$;
var $n_Lraytracer_Entry$;
function $m_Lraytracer_Entry$() {
  if ((!$n_Lraytracer_Entry$)) {
    $n_Lraytracer_Entry$ = new $c_Lraytracer_Entry$()
  };
  return $n_Lraytracer_Entry$
}
/** @constructor */
function $c_Lraytracer_model_Player(pos, dir, height) {
  this.Lraytracer_model_Player__f_pos = null;
  this.Lraytracer_model_Player__f_dir = null;
  this.Lraytracer_model_Player__f_speed = 0.0;
  this.Lraytracer_model_Player__f_rotSpeed = 0.0;
  this.Lraytracer_model_Player__f_FOV = 0;
  this.Lraytracer_model_Player__f_pos = pos;
  this.Lraytracer_model_Player__f_dir = dir;
  this.Lraytracer_model_Player__f_speed = 0.1;
  this.Lraytracer_model_Player__f_rotSpeed = 0.2617993877991494;
  this.Lraytracer_model_Player__f_FOV = 67
}
$c_Lraytracer_model_Player.prototype = new $h_O();
$c_Lraytracer_model_Player.prototype.constructor = $c_Lraytracer_model_Player;
/** @constructor */
function $h_Lraytracer_model_Player() {
  /*<skip>*/
}
$h_Lraytracer_model_Player.prototype = $c_Lraytracer_model_Player.prototype;
function $as_Lraytracer_model_Player(obj) {
  return (((obj instanceof $c_Lraytracer_model_Player) || (obj === null)) ? obj : $throwClassCastException(obj, "raytracer.model.Player"))
}
function $isArrayOf_Lraytracer_model_Player(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lraytracer_model_Player)))
}
function $asArrayOf_Lraytracer_model_Player(obj, depth) {
  return (($isArrayOf_Lraytracer_model_Player(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lraytracer.model.Player;", depth))
}
var $d_Lraytracer_model_Player = new $TypeData().initClass({
  Lraytracer_model_Player: 0
}, false, "raytracer.model.Player", {
  Lraytracer_model_Player: 1,
  O: 1
});
$c_Lraytracer_model_Player.prototype.$classData = $d_Lraytracer_model_Player;
function $p_Lraytracer_view_Raytracer$__ctx$lzyINIT1$1__Lorg_scalajs_dom_HTMLCanvasElement__sr_LazyRef__sjs_js_Dynamic($thiz, canvas$3, ctx$lzy1$1) {
  if ((ctx$lzy1$1 === null)) {
    throw new $c_jl_NullPointerException()
  };
  return ($n(ctx$lzy1$1).sr_LazyRef__f__initialized ? $n(ctx$lzy1$1).sr_LazyRef__f__value : $n(ctx$lzy1$1).initialize__O__O(canvas$3.getContext("2d")))
}
function $p_Lraytracer_view_Raytracer$__ctx$7__Lorg_scalajs_dom_HTMLCanvasElement__sr_LazyRef__sjs_js_Dynamic($thiz, canvas$4, ctx$lzy1$2) {
  return ($n(ctx$lzy1$2).sr_LazyRef__f__initialized ? $n(ctx$lzy1$2).sr_LazyRef__f__value : $p_Lraytracer_view_Raytracer$__ctx$lzyINIT1$1__Lorg_scalajs_dom_HTMLCanvasElement__sr_LazyRef__sjs_js_Dynamic($thiz, canvas$4, ctx$lzy1$2))
}
/** @constructor */
function $c_Lraytracer_view_Raytracer$() {
  /*<skip>*/
}
$c_Lraytracer_view_Raytracer$.prototype = new $h_O();
$c_Lraytracer_view_Raytracer$.prototype.constructor = $c_Lraytracer_view_Raytracer$;
/** @constructor */
function $h_Lraytracer_view_Raytracer$() {
  /*<skip>*/
}
$h_Lraytracer_view_Raytracer$.prototype = $c_Lraytracer_view_Raytracer$.prototype;
$c_Lraytracer_view_Raytracer$.prototype.clearScreen__Lorg_scalajs_dom_HTMLCanvasElement__V = (function(canvas) {
  var ctx = canvas.getContext("2d");
  var x = $uI(canvas.width);
  var x$1 = $uI(canvas.height);
  ctx.clearRect(0.0, 0.0, x, x$1)
});
$c_Lraytracer_view_Raytracer$.prototype.renderWall__Lorg_scalajs_dom_CanvasRenderingContext2D__Lraytracer_model_Player__Lraytracer_model_Wall__D__D__V = (function(ctx, player, wall, canvasWidth, canvasHeight) {
  var playerPos = $n(player).Lraytracer_model_Player__f_pos;
  var playerDir = $n(player).Lraytracer_model_Player__f_dir;
  var this$1 = $n($n($n(wall).Lraytracer_model_Wall__f_start).$minus__Lraytracer_model_Vector2D__Lraytracer_model_Vector2D(playerPos));
  var y = this$1.Lraytracer_model_Vector2D__f_y;
  var x = this$1.Lraytracer_model_Vector2D__f_x;
  var $$x1 = $uD(Math.atan2(y, x));
  var this$4 = $n(playerDir);
  var y$1 = this$4.Lraytracer_model_Vector2D__f_y;
  var x$1 = this$4.Lraytracer_model_Vector2D__f_x;
  var startAngle = ($$x1 - $uD(Math.atan2(y$1, x$1)));
  var this$7 = $n($n($n(wall).Lraytracer_model_Wall__f_end).$minus__Lraytracer_model_Vector2D__Lraytracer_model_Vector2D(playerPos));
  var y$2 = this$7.Lraytracer_model_Vector2D__f_y;
  var x$2 = this$7.Lraytracer_model_Vector2D__f_x;
  var $$x2 = $uD(Math.atan2(y$2, x$2));
  var this$10 = $n(playerDir);
  var y$3 = this$10.Lraytracer_model_Vector2D__f_y;
  var x$3 = this$10.Lraytracer_model_Vector2D__f_x;
  var endAngle = ($$x2 - $uD(Math.atan2(y$3, x$3)));
  var centerAngle = ((startAngle + endAngle) / 2.0);
  var $$x3 = $n($n($n(wall).Lraytracer_model_Wall__f_start).$minus__Lraytracer_model_Vector2D__Lraytracer_model_Vector2D(playerPos)).length__D();
  var x$4 = (3.141592653589793 * (centerAngle / 180.0));
  var distance = ($$x3 * $uD(Math.cos(x$4)));
  var fov = $n(player).Lraytracer_model_Player__f_FOV;
  var startX = $doubleToInt((800.0 * ((startAngle / fov) + 0.5)));
  var endX = $doubleToInt((800.0 * ((endAngle / fov) + 0.5)));
  var wallHeight = $doubleToInt(((600.0 / distance) * canvasHeight));
  var s = $dp_toString__T($n($n(wall).Lraytracer_model_Wall__f_color));
  ctx.fillStyle = s;
  ...
  if ((!isEmpty)) {
    ...
    while (true) {
      var arg1 = i;
      var distanceToGaze = $n($n($n(wall).center__Lraytracer_model_Vector2D()).$minus__Lraytracer_model_Vector2D__Lraytracer_model_Vector2D(playerPos)).length__D();
      var x$5 = ((arg1 / 800.0) - 0.5);
      var distanceToColumn = ($n(new $c_Lraytracer_model_Vector2D(x$5, 0.0).$minus__Lraytracer_model_Vector2D__Lraytracer_model_Vector2D(playerDir)).length__D() * distance);
      var detailLevel = (distanceToGaze / distanceToColumn);
      if ((detailLevel < 0.5)) {
        ctx.fillRect(arg1, ((canvasHeight / 2.0) - ((wallHeight / 2) | 0)), 1.0, wallHeight)
      };
      if ((i === endX)) {
        break
      };
...
$c_Lraytracer_view_Raytracer$.prototype.renderDungeon__Lorg_scalajs_dom_HTMLCanvasElement__Lraytracer_model_Dungeon__V = (function(canvas, dungeon) {
  var ctx = canvas.getContext("2d");
  var this$1 = $n($n(dungeon).Lraytracer_model_Dungeon__f_rooms);
  var these = this$1;
  while ((!$n(these).isEmpty__Z())) {
    var arg1 = $n(these).head__O();
    var room = $as_Lraytracer_model_Room(arg1);
    var this$2 = $n($n(room).walls__sci_List());
    var these$1 = this$2;
    while ((!$n(these$1).isEmpty__Z())) {
      var arg1$1 = $n(these$1).head__O();
      var wall = $as_Lraytracer_model_Wall(arg1$1);
      var $$x1 = $n(dungeon).Lraytracer_model_Dungeon__f_player;
      var x = $uI(canvas.width);
      var x$1 = $uI(canvas.height);
      this.renderWall__Lorg_scalajs_dom_CanvasRenderingContext2D__Lraytracer_model_Player__Lraytracer_model_Wall__D__D__V(ctx, $$x1, wall, x, x$1);
      these$1 = $as_sci_List($n(these$1).tail__O())
    };
    these = $as_sci_List($n(these).tail__O())
  }
});
$c_Lraytracer_view_Raytracer$.prototype.renderSky__Lorg_scalajs_dom_HTMLCanvasElement__V = (function(canvas) {
  var ctx$lzy1 = new $c_sr_LazyRef();
  $p_Lraytracer_view_Raytracer$__ctx$7__Lorg_scalajs_dom_HTMLCanvasElement__sr_LazyRef__sjs_js_Dynamic(this, canvas, ctx$lzy1).fillStyle = "#333";
  var $$x1 = $p_Lraytracer_view_Raytracer$__ctx$7__Lorg_scalajs_dom_HTMLCanvasElement__sr_LazyRef__sjs_js_Dynamic(this, canvas, ctx$lzy1);
  var value = (($uI(canvas.height) / 2) | 0);
  var value$1 = $uI(canvas.width);
  var value$2 = (($uI(canvas.height) / 2) | 0);
  $$x1.fillRect(0, value, value$1, value$2);
  $p_Lraytracer_view_Raytracer$__ctx$7__Lorg_scalajs_dom_HTMLCanvasElement__sr_LazyRef__sjs_js_Dynamic(this, canvas, ctx$lzy1).fillStyle = "#eef";
  var $$x2 = $p_Lraytracer_view_Raytracer$__ctx$7__Lorg_scalajs_dom_HTMLCanvasElement__sr_LazyRef__sjs_js_Dynamic(this, canvas, ctx$lzy1);
  var value$3 = $uI(canvas.width);
  var value$4 = (($uI(canvas.height) / 2) | 0);
  $$x2.fillRect(0, 0, value$3, value$4)
});
var $d_Lraytracer_view_Raytracer$ = new $TypeData().initClass({
  Lraytracer_view_Raytracer$: 0
}, false, "raytracer.view.Raytracer$", {
  Lraytracer_view_Raytracer$: 1,
  O: 1
});
$c_Lraytracer_view_Raytracer$.prototype.$classData = $d_Lraytracer_view_Raytracer$;
var $n_Lraytracer_view_Raytracer$;
function $m_Lraytracer_view_Raytracer$() {
  if ((!$n_Lraytracer_view_Raytracer$)) {
    $n_Lraytracer_view_Raytracer$ = new $c_Lraytracer_view_Raytracer$()
  };
  return $n_Lraytracer_view_Raytracer$
}
/** @constructor */
function $c_Lraytracer_view_TopDown$() {
  /*<skip>*/
}
$c_Lraytracer_view_TopDown$.prototype = new $h_O();
$c_Lraytracer_view_TopDown$.prototype.constructor = $c_Lraytracer_view_TopDown$;
/** @constructor */
function $h_Lraytracer_view_TopDown$() {
  /*<skip>*/
}
$h_Lraytracer_view_TopDown$.prototype = $c_Lraytracer_view_TopDown$.prototype;
$c_Lraytracer_view_TopDown$.prototype.renderRoom__Lorg_scalajs_dom_CanvasRenderingContext2D__Lraytracer_model_Room__V = (function(ctx, room) {
  var this$1 = $n($n(room).walls__sci_List());
  var these = this$1;
  while ((!$n(these).isEmpty__Z())) {
    var arg1 = $n(these).head__O();
    var wall = $as_Lraytracer_model_Wall(arg1);
    matchResult1: {
      var \u03b41$___1;
      var \u03b41$___2;
      var x1 = $n(wall).vertices2d__sci_List();
      if ((x1 !== null)) {
        $n($m_s_package$().s_package$__f_List);
        if (($n(x1).lengthCompare__I__I(2) === 0)) {
          var this$5 = $n(x1);
          var x3 = $as_Lraytracer_model_Vector2D($f_sc_LinearSeqOps__apply__I__O(this$5, 0));
          var this$7 = $n(x1);
          var x4 = $as_Lraytracer_model_Vector2D($f_sc_LinearSeqOps__apply__I__O(this$7, 1));
          var \u03b41$___1 = x3;
          var \u03b41$___2 = x4;
          break matchResult1
        }
    ...
    var start$2 = $as_Lraytracer_model_Vector2D(\u03b41$___1);
    var end$2 = $as_Lraytracer_model_Vector2D(\u03b41$___2);
    ctx.strokeStyle = $n(wall).Lraytracer_model_Wall__f_color;
    ctx.beginPath();
    ctx.moveTo($n(start$2).Lraytracer_model_Vector2D__f_x, $n(start$2).Lraytracer_model_Vector2D__f_y);
    ctx.lineTo($n(end$2).Lraytracer_model_Vector2D__f_x, $n(end$2).Lraytracer_model_Vector2D__f_y);
    ctx.closePath();
    ctx.stroke();
    these = $as_sci_List($n(these).tail__O())
  }
});
$c_Lraytracer_view_TopDown$.prototype.renderPlayer__Lorg_scalajs_dom_CanvasRenderingContext2D__Lraytracer_model_Player__V = (function(ctx, player) {
  var playerPos = $n(player).Lraytracer_model_Player__f_pos;
  ctx.beginPath();
  ctx.fillStyle = "red";
  ctx.arc($n(playerPos).Lraytracer_model_Vector2D__f_x, $n(playerPos).Lraytracer_model_Vector2D__f_y, 10.0, 0.0, 6.283185307179586);
  ctx.fill();
  ctx.closePath();
  ctx.beginPath();
  ctx.fillStyle = "cyan";
  var this$3 = $n($n(player).Lraytracer_model_Player__f_dir);
  var y = this$3.Lraytracer_model_Vector2D__f_y;
  var x = this$3.Lraytracer_model_Vector2D__f_x;
  var angle = $uD(Math.atan2(y, x));
  var x$1 = $n(player).Lraytracer_model_Player__f_FOV;
  var x$2 = x$1;
  var fov = (3.141592653589793 * (x$2 / 180.0));
  var halfFov = (fov / 2.0);
  console.log(angle);
  ctx.moveTo($n(playerPos).Lraytracer_model_Vector2D__f_x, $n(playerPos).Lraytracer_model_Vector2D__f_y);
  ctx.arc($n(playerPos).Lraytracer_model_Vector2D__f_x, $n(playerPos).Lraytracer_model_Vector2D__f_y, 20.0, (angle - halfFov), (angle + halfFov));
  ctx.fill();
  ctx.closePath()
});
$c_Lraytracer_view_TopDown$.prototype.renderDungeon__Lorg_scalajs_dom_HTMLCanvasElement__Lraytracer_model_Dungeon__V = (function(canvas, dungeon) {
  var ctx = canvas.getContext("2d");
  matchResult2: {
    var \u03b42$___1;
    var \u03b42$___2;
    if ((dungeon !== null)) {
      var this$2 = $n(dungeon);
      var x7 = this$2.Lraytracer_model_Dungeon__f_rooms;
      var this$3 = $n(dungeon);
      var x8 = this$3.Lraytracer_model_Dungeon__f_player;
      var \u03b42$___1 = x7;
      var \u03b42$___2 = x8;
      break matchResult2
    };
    throw new $c_s_MatchError(dungeon)
  };
  var rooms$2 = $as_sci_List(\u03b42$___1);
  var player$2 = $as_Lraytracer_model_Player(\u03b42$___2);
  var this$5 = $n(rooms$2);
  var these = this$5;
  while ((!$n(these).isEmpty__Z())) {
    var arg1 = $n(these).head__O();
    var room = $as_Lraytracer_model_Room(arg1);
    this.renderRoom__Lorg_scalajs_dom_CanvasRenderingContext2D__Lraytracer_model_Room__V(ctx, room);
    these = $as_sci_List($n(these).tail__O())
  };
  this.renderPlayer__Lorg_scalajs_dom_CanvasRenderingContext2D__Lraytracer_model_Player__V(ctx, player$2)
});
$c_Lraytracer_view_TopDown$.prototype.clear__Lorg_scalajs_dom_HTMLCanvasElement__V = (function(canvas) {
  var ctx = canvas.getContext("2d");
  var canvasWidth = $uI(canvas.width);
  var canvasHeight = $uI(canvas.height);
  ctx.fillStyle = "black";
  ctx.fillRect(0.0, 0.0, canvasWidth, canvasHeight)
});
var $d_Lraytracer_view_TopDown$ = new $TypeData().initClass({
  Lraytracer_view_TopDown$: 0
}, false, "raytracer.view.TopDown$", {
  Lraytracer_view_TopDown$: 1,
  O: 1
});
$c_Lraytracer_view_TopDown$.prototype.$classData = $d_Lraytracer_view_TopDown$;
var $n_Lraytracer_view_TopDown$;
function $m_Lraytracer_view_TopDown$() {
  if ((!$n_Lraytracer_view_TopDown$)) {
    $n_Lraytracer_view_TopDown$ = new $c_Lraytracer_view_TopDown$()
  };
  return $n_Lraytracer_view_TopDown$
}
...
/** @constructor */
function $c_Lraytracer_model_Room$() {
  this.Lraytracer_model_Room$__f_wallColor1 = null;
  this.Lraytracer_model_Room$__f_wallColor2 = null;
  this.Lraytracer_model_Room$__f_wallColor1 = "#660";
  this.Lraytracer_model_Room$__f_wallColor2 = "#605"
}
$c_Lraytracer_model_Room$.prototype = new $h_O();
$c_Lraytracer_model_Room$.prototype.constructor = $c_Lraytracer_model_Room$;
/** @constructor */
function $h_Lraytracer_model_Room$() {
  /*<skip>*/
}
$h_Lraytracer_model_Room$.prototype = $c_Lraytracer_model_Room$.prototype;
$c_Lraytracer_model_Room$.prototype.toString__T = (function() {
  return "Room"
});
$c_Lraytracer_model_Room$.prototype.walls__Lraytracer_model_Vector2D__D__D__sci_List = (function(origin, roomWidth, roomDepth) {
  matchResult4: {
    var \u03b41$___1;
    var \u03b41$___2;
    if ((origin !== null)) {
      var this$2 = $n(origin);
      var x7 = this$2.Lraytracer_model_Vector2D__f_x;
      var this$3 = $n(origin);
      var x8 = this$3.Lraytracer_model_Vector2D__f_y;
      var \u03b41$___1 = x7;
      var \u03b41$___2 = x8;
      break matchResult4
    };
    throw new $c_s_MatchError(origin)
  };
  var x$2 = $uD(\u03b41$___1);
  var y$2 = $uD(\u03b41$___2);
  $n($m_s_package$().s_package$__f_List);
  ...
  var x = (x$2 + 0.0);
  var y = (y$2 + 0.0);
  var start = new $c_Lraytracer_model_Vector2D(x, y);
  var x$1 = (x$2 + roomWidth);
  var y$1 = (y$2 + 0.0);
  var end = new $c_Lraytracer_model_Vector2D(x$1, y$1);
  var s = this.Lraytracer_model_Room$__f_wallColor1;
  var $$x3 = new $c_Lraytracer_model_Wall(start, end, s);
  var x$3 = (x$2 + roomWidth);
  var y$3 = (y$2 + 0.0);
  var start$1 = new $c_Lraytracer_model_Vector2D(x$3, y$3);
  var x$4 = (x$2 + roomWidth);
  var y$4 = (y$2 + roomDepth);
  var end$1 = new $c_Lraytracer_model_Vector2D(x$4, y$4);
  var s$1 = this.Lraytracer_model_Room$__f_wallColor2;
  var $$x2 = new $c_Lraytracer_model_Wall(start$1, end$1, s$1);
  var x$5 = (x$2 + roomWidth);
  var y$5 = (y$2 + roomDepth);
  var start$2 = new $c_Lraytracer_model_Vector2D(x$5, y$5);
  var x$6 = (x$2 + 0.0);
  var y$6 = (y$2 + roomDepth);
  var end$2 = new $c_Lraytracer_model_Vector2D(x$6, y$6);
  var s$2 = this.Lraytracer_model_Room$__f_wallColor1;
  var $$x1 = new $c_Lraytracer_model_Wall(start$2, end$2, s$2);
  var x$7 = (x$2 + 0.0);
  var y$7 = (y$2 + roomDepth);
  var start$3 = new $c_Lraytracer_model_Vector2D(x$7, y$7);
  var x$8 = (x$2 + 0.0);
  var y$8 = (y$2 + 0.0);
  var end$3 = new $c_Lraytracer_model_Vector2D(x$8, y$8);
  var s$3 = this.Lraytracer_model_Room$__f_wallColor2;
  var elems = $n($$x4).wrapRefArray__AO__sci_ArraySeq(new ($d_Lraytracer_model_Wall.getArrayOf().constr)([$$x3, $$x2, $$x1, new $c_Lraytracer_model_Wall(start$3, end$3, s$3)]));
  return $m_sci_Nil$().prependedAll__sc_IterableOnce__sci_List(elems)
});
var $d_Lraytracer_model_Room$ = new $TypeData().initClass({
  Lraytracer_model_Room$: 0
}, false, "raytracer.model.Room$", {
  Lraytracer_model_Room$: 1,
  O: 1,
  s_deriving_Mirror: 1,
  s_deriving_Mirror$Product: 1
});
$c_Lraytracer_model_Room$.prototype.$classData = $d_Lraytracer_model_Room$;
var $n_Lraytracer_model_Room$;
function $m_Lraytracer_model_Room$() {
  if ((!$n_Lraytracer_model_Room$)) {
    $n_Lraytracer_model_Room$ = new $c_Lraytracer_model_Room$()
  };
  return $n_Lraytracer_model_Room$
}
...
/** @constructor */
function $c_Lraytracer_model_Dungeon(rooms, player) {
  this.Lraytracer_model_Dungeon__f_rooms = null;
  this.Lraytracer_model_Dungeon__f_player = null;
  this.Lraytracer_model_Dungeon__f_rooms = rooms;
  this.Lraytracer_model_Dungeon__f_player = player
}
$c_Lraytracer_model_Dungeon.prototype = new $h_O();
$c_Lraytracer_model_Dungeon.prototype.constructor = $c_Lraytracer_model_Dungeon;
/** @constructor */
function $h_Lraytracer_model_Dungeon() {
  /*<skip>*/
}
$h_Lraytracer_model_Dungeon.prototype = $c_Lraytracer_model_Dungeon.prototype;
$c_Lraytracer_model_Dungeon.prototype.productIterator__sc_Iterator = (function() {
  return new $c_s_Product$$anon$1(this)
});
$c_Lraytracer_model_Dungeon.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__Z__I(this, (-889275714), false)
});
$c_Lraytracer_model_Dungeon.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$()._toString__s_Product__T(this)
});
$c_Lraytracer_model_Dungeon.prototype.productArity__I = (function() {
  return 2
});
$c_Lraytracer_model_Dungeon.prototype.productPrefix__T = (function() {
  return "Dungeon"
});
$c_Lraytracer_model_Dungeon.prototype.productElement__I__O = (function(n) {
  if ((n === 0)) {
    return this.Lraytracer_model_Dungeon__f_rooms
  };
  if ((n === 1)) {
    return this.Lraytracer_model_Dungeon__f_player
  };
  throw $ct_jl_IndexOutOfBoundsException__T__(new $c_jl_IndexOutOfBoundsException(), ("" + n))
});
var $d_Lraytracer_model_Dungeon = new $TypeData().initClass({
  Lraytracer_model_Dungeon: 0
}, false, "raytracer.model.Dungeon", {
  Lraytracer_model_Dungeon: 1,
  O: 1,
  s_Equals: 1,
  s_Product: 1,
  Ljava_io_Serializable: 1
});
$c_Lraytracer_model_Dungeon.prototype.$classData = $d_Lraytracer_model_Dungeon;
/** @constructor */
function $c_Lraytracer_model_Room(roomOrigin, roomWidth, roomDepth, roomHeight) {
  this.Lraytracer_model_Room__f_roomOrigin = null;
  this.Lraytracer_model_Room__f_roomWidth = 0.0;
  this.Lraytracer_model_Room__f_roomDepth = 0.0;
  this.Lraytracer_model_Room__f_roomHeight = 0.0;
  this.Lraytracer_model_Room__f_walls$lzy1 = null;
  this.Lraytracer_model_Room__f_wallsbitmap$1 = false;
  this.Lraytracer_model_Room__f_roomOrigin = roomOrigin;
  this.Lraytracer_model_Room__f_roomWidth = roomWidth;
  this.Lraytracer_model_Room__f_roomDepth = roomDepth;
  this.Lraytracer_model_Room__f_roomHeight = roomHeight
}
$c_Lraytracer_model_Room.prototype = new $h_O();
$c_Lraytracer_model_Room.prototype.constructor = $c_Lraytracer_model_Room;
/** @constructor */
...
$h_Lraytracer_model_Room.prototype = $c_Lraytracer_model_Room.prototype;
$c_Lraytracer_model_Room.prototype.productIterator__sc_Iterator = (function() {
  return new $c_s_Product$$anon$1(this)
});
$c_Lraytracer_model_Room.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  var hash = acc;
  var data = $f_T__hashCode__I("Room");
  acc = $m_sr_Statics$().mix__I__I__I(hash, data);
  var hash$1 = acc;
  var x = this.Lraytracer_model_Room__f_roomOrigin;
  var data$1 = $m_sr_Statics$().anyHash__O__I(x);
  acc = $m_sr_Statics$().mix__I__I__I(hash$1, data$1);
  var hash$2 = acc;
  var dv = this.Lraytracer_model_Room__f_roomWidth;
  var data$2 = $m_sr_Statics$().doubleHash__D__I(dv);
  acc = $m_sr_Statics$().mix__I__I__I(hash$2, data$2);
  var hash$3 = acc;
  var dv$1 = this.Lraytracer_model_Room__f_roomDepth;
  var data$3 = $m_sr_Statics$().doubleHash__D__I(dv$1);
  acc = $m_sr_Statics$().mix__I__I__I(hash$3, data$3);
  var hash$4 = acc;
  var dv$2 = this.Lraytracer_model_Room__f_roomHeight;
...
$c_Lraytracer_model_Room.prototype.productArity__I = (function() {
  return 4
});
$c_Lraytracer_model_Room.prototype.productPrefix__T = (function() {
  return "Room"
});
$c_Lraytracer_model_Room.prototype.productElement__I__O = (function(n) {
  switch (n) {
    case 0: {
      return this.Lraytracer_model_Room__f_roomOrigin;
      break
    }
    case 1: {
      return this.Lraytracer_model_Room__f_roomWidth;
      break
    }
    case 2: {
      return this.Lraytracer_model_Room__f_roomDepth;
      break
    }
    case 3: {
      return this.Lraytracer_model_Room__f_roomHeight;
      break
    }
    default: {
      throw $ct_jl_IndexOutOfBoundsException__T__(new $c_jl_IndexOutOfBoundsException(), ("" + n))
...
$c_Lraytracer_model_Room.prototype.walls__sci_List = (function() {
  if ((!this.Lraytracer_model_Room__f_wallsbitmap$1)) {
    this.Lraytracer_model_Room__f_walls$lzy1 = $m_Lraytracer_model_Room$().walls__Lraytracer_model_Vector2D__D__D__sci_List(this.Lraytracer_model_Room__f_roomOrigin, this.Lraytracer_model_Room__f_roomWidth, this.Lraytracer_model_Room__f_roomDepth);
    this.Lraytracer_model_Room__f_wallsbitmap$1 = true
  };
  return this.Lraytracer_model_Room__f_walls$lzy1
});
function $as_Lraytracer_model_Room(obj) {
  return (((obj instanceof $c_Lraytracer_model_Room) || (obj === null)) ? obj : $throwClassCastException(obj, "raytracer.model.Room"))
}
function $isArrayOf_Lraytracer_model_Room(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lraytracer_model_Room)))
}
function $asArrayOf_Lraytracer_model_Room(obj, depth) {
  return (($isArrayOf_Lraytracer_model_Room(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lraytracer.model.Room;", depth))
}
var $d_Lraytracer_model_Room = new $TypeData().initClass({
  Lraytracer_model_Room: 0
}, false, "raytracer.model.Room", {
...
$c_Lraytracer_model_Room.prototype.$classData = $d_Lraytracer_model_Room;
/** @constructor */
function $c_Lraytracer_model_Vector2D(x, y) {
  this.Lraytracer_model_Vector2D__f_x = 0.0;
  this.Lraytracer_model_Vector2D__f_y = 0.0;
  this.Lraytracer_model_Vector2D__f_x = x;
  this.Lraytracer_model_Vector2D__f_y = y
}
$c_Lraytracer_model_Vector2D.prototype = new $h_O();
$c_Lraytracer_model_Vector2D.prototype.constructor = $c_Lraytracer_model_Vector2D;
/** @constructor */
function $h_Lraytracer_model_Vector2D() {
  /*<skip>*/
}
$h_Lraytracer_model_Vector2D.prototype = $c_Lraytracer_model_Vector2D.prototype;
$c_Lraytracer_model_Vector2D.prototype.productIterator__sc_Iterator = (function() {
  return new $c_s_Product$$anon$1(this)
});
$c_Lraytracer_model_Vector2D.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  var hash = acc;
  var data = $f_T__hashCode__I("Vector2D");
  acc = $m_sr_Statics$().mix__I__I__I(hash, data);
  var hash$1 = acc;
  var dv = this.Lraytracer_model_Vector2D__f_x;
  var data$1 = $m_sr_Statics$().doubleHash__D__I(dv);
  acc = $m_sr_Statics$().mix__I__I__I(hash$1, data$1);
  var hash$2 = acc;
  var dv$1 = this.Lraytracer_model_Vector2D__f_y;
  var data$2 = $m_sr_Statics$().doubleHash__D__I(dv$1);
  acc = $m_sr_Statics$().mix__I__I__I(hash$2, data$2);
  var hash$3 = acc;
  return $m_sr_Statics$().finalizeHash__I__I__I(hash$3, 2)
});
$c_Lraytracer_model_Vector2D.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$()._toString__s_Product__T(this)
});
$c_Lraytracer_model_Vector2D.prototype.productArity__I = (function() {
  return 2
});
$c_Lraytracer_model_Vector2D.prototype.productPrefix__T = (function() {
  return "Vector2D"
});
$c_Lraytracer_model_Vector2D.prototype.productElement__I__O = (function(n) {
  if ((n === 0)) {
    return this.Lraytracer_model_Vector2D__f_x
  };
  if ((n === 1)) {
    return this.Lraytracer_model_Vector2D__f_y
  };
  throw $ct_jl_IndexOutOfBoundsException__T__(new $c_jl_IndexOutOfBoundsException(), ("" + n))
});
$c_Lraytracer_model_Vector2D.prototype.$plus__Lraytracer_model_Vector2D__Lraytracer_model_Vector2D = (function(other) {
  var x = (this.Lraytracer_model_Vector2D__f_x + $n(other).Lraytracer_model_Vector2D__f_x);
  var y = (this.Lraytracer_model_Vector2D__f_y + $n(other).Lraytracer_model_Vector2D__f_y);
  return new $c_Lraytracer_model_Vector2D(x, y)
});
$c_Lraytracer_model_Vector2D.prototype.$minus__Lraytracer_model_Vector2D__Lraytracer_model_Vector2D = (function(other) {
  var x = (this.Lraytracer_model_Vector2D__f_x - $n(other).Lraytracer_model_Vector2D__f_x);
  var y = (this.Lraytracer_model_Vector2D__f_y - $n(other).Lraytracer_model_Vector2D__f_y);
  return new $c_Lraytracer_model_Vector2D(x, y)
});
$c_Lraytracer_model_Vector2D.prototype.$times__D__Lraytracer_model_Vector2D = (function(value) {
  var x = (this.Lraytracer_model_Vector2D__f_x * value);
  var y = (this.Lraytracer_model_Vector2D__f_y * value);
  return new $c_Lraytracer_model_Vector2D(x, y)
});
$c_Lraytracer_model_Vector2D.prototype.$div__D__Lraytracer_model_Vector2D = (function(value) {
  var x = (this.Lraytracer_model_Vector2D__f_x / value);
  var y = (this.Lraytracer_model_Vector2D__f_y / value);
  return new $c_Lraytracer_model_Vector2D(x, y)
});
$c_Lraytracer_model_Vector2D.prototype.length__D = (function() {
  var x = ((this.Lraytracer_model_Vector2D__f_x * this.Lraytracer_model_Vector2D__f_x) + (this.Lraytracer_model_Vector2D__f_y * this.Lraytracer_model_Vector2D__f_y));
  return $uD(Math.sqrt(x))
});
$c_Lraytracer_model_Vector2D.prototype.rotate__D__Lraytracer_model_Vector2D = (function(angle) {
  var cos = $uD(Math.cos(angle));
  var sin = $uD(Math.sin(angle));
  var x = ((this.Lraytracer_model_Vector2D__f_x * cos) - (this.Lraytracer_model_Vector2D__f_y * sin));
  var y = ((this.Lraytracer_model_Vector2D__f_x * sin) + (this.Lraytracer_model_Vector2D__f_y * cos));
  return new $c_Lraytracer_model_Vector2D(x, y)
});
function $as_Lraytracer_model_Vector2D(obj) {
  return (((obj instanceof $c_Lraytracer_model_Vector2D) || (obj === null)) ? obj : $throwClassCastException(obj, "raytracer.model.Vector2D"))
}
function $isArrayOf_Lraytracer_model_Vector2D(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lraytracer_model_Vector2D)))
}
function $asArrayOf_Lraytracer_model_Vector2D(obj, depth) {
  return (($isArrayOf_Lraytracer_model_Vector2D(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lraytracer.model.Vector2D;", depth))
}
var $d_Lraytracer_model_Vector2D = new $TypeData().initClass({
  Lraytracer_model_Vector2D: 0
}, false, "raytracer.model.Vector2D", {
  Lraytracer_model_Vector2D: 1,
  O: 1,
  s_Equals: 1,
  s_Product: 1,
  Ljava_io_Serializable: 1
});
$c_Lraytracer_model_Vector2D.prototype.$classData = $d_Lraytracer_model_Vector2D;
/** @constructor */
function $c_Lraytracer_model_Wall(start, end, color) {
  this.Lraytracer_model_Wall__f_start = null;
  this.Lraytracer_model_Wall__f_end = null;
  this.Lraytracer_model_Wall__f_color = null;
  this.Lraytracer_model_Wall__f_start = start;
  this.Lraytracer_model_Wall__f_end = end;
  this.Lraytracer_model_Wall__f_color = color
}
$c_Lraytracer_model_Wall.prototype = new $h_O();
$c_Lraytracer_model_Wall.prototype.constructor = $c_Lraytracer_model_Wall;
/** @constructor */
function $h_Lraytracer_model_Wall() {
  /*<skip>*/
}
$h_Lraytracer_model_Wall.prototype = $c_Lraytracer_model_Wall.prototype;
$c_Lraytracer_model_Wall.prototype.productIterator__sc_Iterator = (function() {
  return new $c_s_Product$$anon$1(this)
});
$c_Lraytracer_model_Wall.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__Z__I(this, (-889275714), false)
});
$c_Lraytracer_model_Wall.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$()._toString__s_Product__T(this)
});
$c_Lraytracer_model_Wall.prototype.productArity__I = (function() {
  return 3
});
$c_Lraytracer_model_Wall.prototype.productPrefix__T = (function() {
  return "Wall"
});
$c_Lraytracer_model_Wall.prototype.productElement__I__O = (function(n) {
  switch (n) {
    case 0: {
      return this.Lraytracer_model_Wall__f_start;
      break
    }
    case 1: {
      return this.Lraytracer_model_Wall__f_end;
      break
    }
    case 2: {
      return this.Lraytracer_model_Wall__f_color;
      break
    }
    default: {
      throw $ct_jl_IndexOutOfBoundsException__T__(new $c_jl_IndexOutOfBoundsException(), ("" + n))
...
$c_Lraytracer_model_Wall.prototype.center__Lraytracer_model_Vector2D = (function() {
  return $n($n(this.Lraytracer_model_Wall__f_start).$plus__Lraytracer_model_Vector2D__Lraytracer_model_Vector2D(this.Lraytracer_model_Wall__f_end)).$div__D__Lraytracer_model_Vector2D(2.0)
});
$c_Lraytracer_model_Wall.prototype.vertices2d__sci_List = (function() {
  $n($m_s_package$().s_package$__f_List);
  var elems = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lraytracer_model_Vector2D.getArrayOf().constr)([this.Lraytracer_model_Wall__f_start, this.Lraytracer_model_Wall__f_end]));
  return $m_sci_Nil$().prependedAll__sc_IterableOnce__sci_List(elems)
});
function $as_Lraytracer_model_Wall(obj) {
  return (((obj instanceof $c_Lraytracer_model_Wall) || (obj === null)) ? obj : $throwClassCastException(obj, "raytracer.model.Wall"))
}
function $isArrayOf_Lraytracer_model_Wall(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lraytracer_model_Wall)))
}
function $asArrayOf_Lraytracer_model_Wall(obj, depth) {
  return (($isArrayOf_Lraytracer_model_Wall(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lraytracer.model.Wall;", depth))
}
var $d_Lraytracer_model_Wall = new $TypeData().initClass({
  Lraytracer_model_Wall: 0
}, false, "raytracer.model.Wall", {
  Lraytracer_model_Wall: 1,
  O: 1,
  s_Equals: 1,
  s_Product: 1,
  Ljava_io_Serializable: 1
});
$c_Lraytracer_model_Wall.prototype.$classData = $d_Lraytracer_model_Wall;
/** @constructor */
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
Entry = $m_Lraytracer_Entry$();
$s_Lraytracer_Entry__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
//# sourceMappingURL=renderer-fastopt.js.map
